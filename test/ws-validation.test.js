...
describe('error message sanitization', () => {
  it('returns generic error for windows 404', async () => {
    const { base } = await startServer({
      listWindowsFn: vi.fn().mockRejectedValue(new Error('can\'t find session: /tmp/tmux-1000/default')),
    });
